...
zubax_chibios::config::Param<unsigned> param_can_bitrate("uavcan.bit_rate", 1000000, 20000, 1000000);
zubax_chibios::config::Param<unsigned> param_node_id("uavcan.node_id", 50, 1, 125);

...
static void restart(void *p) {
  ...
  chSysLockFromIsr();
  uartStartSendI(&UARTD3, 14, "Hello World!\r\n");
...
int main(void) {
  ...
  chSysInit();
    ...
    palSetPadMode(GPIOD, 5, PAL_MODE_STM32_ALTERNATE_PUSHPULL); //UART2
    palSetPadMode(GPIOD, 6, 3);  

    palSetPadMode(GPIOC, 10, PAL_MODE_STM32_ALTERNATE_PUSHPULL);  //UART3
    palSetPadMode(GPIOC, 11, 3);    
